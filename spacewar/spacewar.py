...
YELLOW_HIT=pygame.USEREVENT+1  #Here +1 is not for sum function but for creating a separate identification
RED_HIT=pygame.USEREVENT+2 #Here +2 is not for sum function but for creating a separate identification
...
def yellow_handle_movement(keys_pressed,yellow):
    ...
    if keys_pressed[pygame.K_a] and yellow.x-VEL >0:  #Left
        yellow.x-=VEL
    if keys_pressed[pygame.K_d] and yellow.x + VEL + yellow.width < BORDER.x-5:  #Right
        yellow.x+=VEL        
